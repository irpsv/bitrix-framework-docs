...
Для экранирования HTML внутри самого Javascript, можно использовать методы класса `Text` встроенной `main.core` библиотеки:
```js
...
Также данный класс можно получить через импорт:
```js
